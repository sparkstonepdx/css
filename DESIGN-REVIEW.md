...
| Micro-interactions | `.btn` eases colour changes and grows to `scale(1.02)` while pressed, your call over the earlier shrink; menu rows, tabs and collapse titles ease their hover | colour transitions also animate a scheme switch on those elements |
